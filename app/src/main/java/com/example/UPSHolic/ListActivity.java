...
public class ListActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private TextView tv_orientation,tv_text,tv_list_title,tv_list_subtitle;
    private Switch sw_maps;
    private Toolbar Bar;
    private CheckBox cb_location;
    private FusedLocationProviderClient LocationProvider;// fonction par default de l'API de google
    private LocationRequest locationRequest;
    private LocationCallback locationCallback;
    private ListView peakFront;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        Peak = com.example.calcul.PeakInFront.searchPeak(me,db.Peak,mAzimuth,mode);
